...
# save paths to model files
prototxt_path = "/Users/carolinazubler/Library/Mobile Documents/com~apple~CloudDocs/Documents/Yale/Senior Year/Fall 2024/CPSC 490/cvfored/src/face extraction/deploy.prototxt"

caffe_model_path = "/Users/carolinazubler/Library/Mobile Documents/com~apple~CloudDocs/Documents/Yale/Senior Year/Fall 2024/CPSC 490/cvfored/src/face extraction/res10_300x300_ssd_iter_140000.caffemodel"
...
def cvDnnDetectFaces(image, opencv_dnn_model, min_confidence, display = True):
...
### Two-Pass Face Detection Function ###

def TwoPassFaceDetection(image, first_conf, second_conf, model, im):

    # run first pass of model on image
    final_image, output, extractions, face_count = cvDnnDetectFaces(image, model, first_conf, display=False)
    ...
    # if faces found, run second pass
        ...
        for i in extractions:
            if cvDnnDetectFaces(i, model, second_conf, display=False)[3] > 0:
...
for filename in os.listdir(image_directory):
    ...
    if filename.endswith(".jpg") or filename.endswith(".png"):
        ...
        # use image as input
        initial_count, final_count = TwoPassFaceDetection(image, 0.13, 0.99, opencv_dnn_model, var)
